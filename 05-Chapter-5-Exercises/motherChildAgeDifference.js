/*
 ...
 child is born). You can use the average function defined earlier in this chapter.
...
/*
var doesItWork = hasMom.map(function(person){
    return person.born - byName[person.mother].born;
});

console.log(hasMom.map(function(person){
    return person.born - byName[person.mother].born;
}));

 console.log(average(doesItWork));
 */

console.log(Math.round(average(hasMom.map(function(person){
    return person.born - byName[person.mother].born;
}))*10)/10);